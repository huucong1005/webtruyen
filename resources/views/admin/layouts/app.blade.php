    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu navigation" data-widget="tree">
                ...
                <li class="{{ isset($home) ? 'active menu-open' : '' }}"><a href="{{ route('admin.home') }}"><i class="fa fa-home"></i> <span>Bảng thống kê</span></a></li>
                @endif
                @if($level == 2 | $level == 3)
                <li class="{{ isset($category_menu) ? 'active menu-open' : '' }}"><a href="{{ route('admin.category.index') }}"><i class="fa fa-folder-o"></i> <span>Quản lý chuyên mục</span></a></li>
                @endif
                @if( $level == 1 | $level == 2 | $level == 3)
                <li class="{{ isset($author_menu) ? 'active menu-open' : '' }}"><a href="{{ route('admin.author.index') }}"><i class="fa fa-user"></i> <span>Quản lý tác giả</span></a></li>
                @endif
                @if($level == 1 || $level == 2 | $level == 3)
                <li class="treeview">
                    <a href="#">
                ...
                @endif
                @if($level == 3)
                <li class="{{ isset($user_menu) ? 'active menu-open' : '' }}"><a href="{{ route('admin.user.index') }}"><i class="fa fa-lock fa-fw"></i>Quản lý thành viên</a></li>
